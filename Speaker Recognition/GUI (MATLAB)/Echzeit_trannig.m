function varargout = Echzeit_trannig(varargin)
% ECHZEIT_TRANNIG MATLAB code for Echzeit_trannig.fig
%      ECHZEIT_TRANNIG, by itself, creates a new ECHZEIT_TRANNIG or raises the existing
%      singleton*.
%
%      H = ECHZEIT_TRANNIG returns the handle to a new ECHZEIT_TRANNIG or the handle to
%      the existing singleton*.
%
%      ECHZEIT_TRANNIG('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ECHZEIT_TRANNIG.M with the given input arguments.
%
%      ECHZEIT_TRANNIG('Property','Value',...) creates a new ECHZEIT_TRANNIG or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Echzeit_trannig_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Echzeit_trannig_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Echzeit_trannig

% Last Modified by GUIDE v2.5 21-Oct-2017 16:49:10

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Echzeit_trannig_OpeningFcn, ...
                   'gui_OutputFcn',  @Echzeit_trannig_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Echzeit_trannig is made visible.
function Echzeit_trannig_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Echzeit_trannig (see VARARGIN)
axes(handles.axes2)
...
VX=cell(50,1);
% Choose default command line output for Echzeit_trannig
...
% UIWAIT makes Echzeit_trannig wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Echzeit_trannig_OutputFcn(hObject, eventdata, handles) 

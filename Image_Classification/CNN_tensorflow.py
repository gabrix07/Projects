...
# In[2]: Loading Pictures and dividing in Training- and Test-Set
...
# In[3]:Converting data into Vectors
...
# In[4]:Dividing in mini Batche of size mini_batch
...
# In[5]: Creating the Convolutional Network  
...
# In[5]: Computing the cost function
def compute_cost(Z3, Y):
    cost = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits_v2(logits=Z3, labels=Y))
    return cost

# In[5]: Spreding and saving the image 
